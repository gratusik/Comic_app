...
object AnnotationProcessorsDependencies {
    const val HILT_ANDROID_COMPILER =
        "com.google.dagger:hilt-android-compiler:${Libs.Versions.HILT}"
    const val HILT_VIEW_MODEL_COMPILER =
        "androidx.hilt:hilt-compiler:${Libs.Versions.HILT_VIEW_MODEL}"
    ...
    const val DATA_BINDING = "com.android.databinding:compiler:${Libs.Versions.DATA_BINDING}"
}

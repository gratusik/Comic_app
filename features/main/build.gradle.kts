...
dependencies {
    ...
    implementation(project(build.Modules.Features.COMIC_CARD))
    implementation(project(build.Modules.Features.COMIC_LIST))
    implementation(project(build.Modules.Features.COMIC_MORE))
